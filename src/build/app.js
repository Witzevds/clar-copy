(() => {
  ...
  var titleAppear = () => {
    ...
    let h1 = document.querySelectorAll("[data-animation='title-appear']");
    tl.from("[data-animation='title-appear']", {
      opacity: 0,
      rotate: 1,
      y: 100,
      duration: 1
  ...
  var pointer = function() {
    gsapWithCSS.set(".flair", { xPercent: -50, yPercent: -50 });
    let xTo = gsapWithCSS.quickTo(".flair", "x", { duration: 0.6, ease: "power3" }), yTo = gsapWithCSS.quickTo(".flair", "y", { duration: 0.6, ease: "power3" });
