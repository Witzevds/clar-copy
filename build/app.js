(() => {
    ...
    $pinContainers.forEach(($pinContainer) => {
      ...
      ScrollTrigger2.create({
        ...
        onUpdate: (self) => {
          ...
          const translateY = Math.abs(
            scrollPosition / ($pinContainer.offsetHeight - window.innerHeight)
          ) * 230;
          gsapWithCSS.set($pinElement, { y: `${translateY}%` });
        }
      });
    });
  };
  var pin_default = initPin;

  // src/scripts/animations/horizontal.js
  var initHorizontalScroll = () => {
  ...
  // src/scripts/animations/titleAppear.js
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  var titleAppear = () => {
  ...
  var titleAppear_default = titleAppear;

  // src/scripts/animations/pointer.js
  var pointer = function() {
    gsapWithCSS.set(".mouse", { xPercent: -50, yPercent: -50 });
    let xTo = gsapWithCSS.quickTo(".mouse", "x", { duration: 0.6, ease: "power3" }), yTo = gsapWithCSS.quickTo(".mouse", "y", { duration: 0.6, ease: "power3" });
  ...
  // src/scripts/animations/lottie.js
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  var initPinLottie = () => {
    const $pinContainers = document.querySelectorAll(
    ...
    $pinContainers.forEach(($pinContainer) => {
      ...
      ScrollTrigger2.create({
        ...
        onUpdate: (self) => {
          ...
          gsapWithCSS.to($pinElement, { y: `${translateY}%`, ease: "none" });
        }
      });
    });
  };
  var lottie_default = initPinLottie;

  // src/scripts/animations/circle-animation.js
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  function initCircleAnimation() {
    document.querySelectorAll("[data-animation='circle-animation']").forEach(($circleContainer) => {
  ...
  var circle_animation_default = initCircleAnimation;

  // src/scripts/animations/overlay.js
  ...
  var overlay_default = showOverlay;
